...
this.opt.disabledImage)};vorple.button.Image.prototype.enable=function(){this.enabled=!0;d("."+this.idClass).attr("src",this.url)};vorple.button.Image.prototype.isEnabled=function(){return this.enabled};vorple.button.Group=function(a,c){function b(a){"string"===typeof a||"object"===typeof a&&"undefined"!==typeof a.jquery?e.append(a):a&&e.append(a.html())}var e,f=[];if("object"===d.type(c)||"undefined"===typeof c||!c)if("object"===d.type(c)&&"undefined"!==typeof c.jquery)e=c;else{if("object"!==d.type(c))c=
{tag:"div"};else if("undefined"===typeof c.tag)c.tag="div";e=d(vorple.html.tag(c.tag,null,c,{endTag:"never"}))}else e="string"===d.type(c)?d(c):d(vorple.button.defaults.groupParent);"array"===d.type(a)?f=a:"undefined"!==typeof a&&a&&f.push(a);d.each(f,function(a,c){b(c)});this.add=function(a){d.each("array"!==typeof a?[a]:a,function(a,c){var e=!1;"object"===typeof c&&"idClass"in c&&d.each(f,function(a,b){"object"===typeof b&&"idClass"in b&&c.idClass==b.idClass&&(e=!0)});e||(f.push(c),b(c))})};this.contains=
function(a){return-1<d.inArray(a,f)};this.enable=function(){d.each(f,function(a,b){d.isFunction(b.enable)&&b.enable()})};this.disable=function(){d.each(f,function(a,b){d.isFunction(b.disable)&&b.disable()})};this.html=function(){return vorple.html.$toHtml(e)};this.update=function(a,c){var h=[];c?(d.each(f,function(b,c){"object"===typeof c&&"idClass"in c&&d.each(a,function(a,b){"object"===typeof b&&"idClass"in b&&c.idClass==b.idClass&&h.push(b)})}),d.each(a,function(a,b){var c=!1;"object"===typeof b&&
"idClass"in b&&d.each(h,function(a,d){"object"===typeof d&&"idClass"in d&&d.idClass==b.idClass&&(c=!0)});c||h.push(b)})):h=a;"array"!==d.type(a)&&(h=[a]);f=h;e.html("");d.each(h,function(a,c){b(c)})}}})(jQuery);(function(d){vorple.cookie={};vorple.cookie.defaults={expires:365};vorple.cookie.read=function(a,c){var b,e=d.extend({},self.defaults,c).raw?function(a){return a}:decodeURIComponent;return(b=RegExp("(?:^|; )"+encodeURIComponent(a)+"=([^;]*)").exec(document.cookie))?e(b[1]):null};vorple.cookie.remove=function(a){this.write(a,null)};vorple.cookie.write=function(a,c,b){b=d.extend({},this.defaults,b);if(null===c||void 0===c)b.expires=-1;if("number"===typeof b.expires){var e=b.expires,f=b.expires=new Date;
...
d("body").on("click",".popuplink_"+f,function(a){a.preventDefault();d(".linkPopup").hide();g.appendTo("body").show().offset({left:a.pageX,top:a.pageY});d(document).one("click",function(){d(".linkPopup").hide();console.log("click")})});d("body").on("click",".popup_"+f+" a",function(a){a.preventDefault();vorple.core.doLink(d(this).attr("href"));return!1});b.classes+="popupLink popuplink_"+f;return vorple.html.link("#",c,b)}return"object"===typeof a?e._createLink(a):e._createLink({url:a,content:c,options:b})};
vorple.html.p=function(a,c){return vorple.html.tag("p",a,c)};vorple.html.quote=function(a,c){var b,d;if("undefined"==typeof c)c=this.defaults.quotemarks;"string"==typeof c?d=b=c:(b=c[0],d=c[1]);return b+a+d};vorple.html.replaceAttributes=function(a,c){for(var b=a.get(0).attributes,e=0;e<b.length;++e)a.attr(b[e].name,"");d.each(c,function(b,c){"classes"==b?a.attr("class",c):a.attr(b,c)})};vorple.html.tag=function(a,c,b){var e=d.extend({},this.defaults,b),b="<"+a+this.attributes(e);"always"==e.endTag||
"auto"==e.endTag&&"string"===typeof c?("string"!==typeof c&&!c&&(c=""),a=">"+c+"</"+a+">"):a=c?">"+c:"auto"==e.endTag?" />":">";return b+a};vorple.html.url=function(a,c){return"undefined"==typeof a||!a?"undefined"==typeof c||!c?c:"#":"undefined"==typeof c||!c||a.match(/^[a-zA-Z]*:\/\//)||0===a.indexOf("/")||0===a.indexOf(".")?a:c+"/"+a}})(jQuery);(function(d){vorple.media={_muted:{music:!1,sound:!1}};vorple.media.defaults={type:"sound",audioPath:"media/audio",imagePath:"media/image",musicPath:"media/music",videoPath:"media/video",muted:!1,mainContainer:"vorple-media",musicContainer:"vorple-music",soundContainer:"vorple-sound",playerSolution:"html, flash",preload:"auto",swfPath:"lib",volume:0.8};vorple.media._createMainContainer=function(a,c){0==d("#"+a).length&&("undefined"===typeof c&&(c=d("body")),c.append(d('<div id="'+a+'"></div>')));
